...
app.config(function($translateProvider) {
	$translateProvider.translations('ru', {
		...
		mauni: '<em>2011 - Настоящее время (6 курс)</em><br>Факультет: Факультет заочного обучения<br>Специальность: Электронные вычислительные средства<br>Квалификация: Инженер-электроник',
		mexp: 'Опыт работы',
		moptiman: 'Торговая сеть "Optima" (ООО "Промтраст энд Ко")',
		...
		mskills1: 'Настройка серверов (OpenVPN, Squid, Samba, Web (Apache+MySQL+PHP))',
	...
	.translations('en', {
		...
		en: 'English',
		pl: 'Polski',
		multititle: 'Vlad Kevan - personal page',
		...
		macoll: '<em>2007 - 2011</em><br>Faculty: Automation and Information<br>Speciality: Computers, systems and nets<br>Specialization: Operation of local computer networks<br>Qualification: technician',
		mnuni: 'Belarusian State University of Informatics and Radio Electronics',
		mauni: '<em>2011 - until now (6 course)</em><br>Faculty: Faculty of distance learning<br>Speciality: Electronic computing means<br>Qualifications: Electronic engineer',
		mexp: 'Experience',
		moptiman: 'Trading network "Optima" (Promtrast & Co LLC)',
		mingel: 'The system administrator (Electronic engineer)',
		mowtime: 'September 2013 - until now',
		moptadm0: 'Administration servers on the OS Windows Server, Linux',
		...
		moptadm3: 'Technical support, including remote',
		moptadm4: 'Service cash equipment',
		...
		maoradm2: 'Service printers and copiers',
		...
		mskills1: 'Configure servers (OpenVPN, Squid, Samba, Web (Apache+MySQL+PHP))',
		...
		mskills4: 'Some experience in programming (C#, Assembler, JavaScript, Pascal)<br>Начальные знания Microsoft .NET Core',
		moth: 'Other',
		moth0: 'Availability of personal vehicle and permit the vehicle categories B',
		moth1: 'No bad habits',
		moth2: 'The possibility of formal employment in the Republic of Poland',
		mperq: 'Personal qualities',
		mperq0: 'Practicality',
		mperq1: 'Responsibility',
		mperq2:'Discipline',
		mperq3:  'Educability',
		mdowr:  'Download resume',
		mcontact: 'Contacts',
		mcont0: 'Name:',
		mcont1: 'Vlad Kevan',
		mcont2:'Address:',
	...
	.translations('pl', {
		...
		meduc: 'Edukacja',
		mncoll: 'Grodzieński państwowy Politechniczny kolegium',
		...
		mauni: '<em>2011 - Do tej chwili (6 kurs)</em><br>Wydział: Wydział kształcenia na odległość<br>Specjalność: Elektroniczne narzędzia obliczeniowe<br>Kwalifikacje: Inżynier-elektronik',
		mexp: 'Doświadczenie w pracy',
		moptiman: 'Sieć handlowa "Optima" (SP. z o. o. "Promtrast & Co")',
		mingel: 'Administrator systemu (Inżynier-elektronik)',
		mowtime: 'Wrzesień 2013 - Do tej chwili',
		...
		moptadm4: 'Obsługa urządzenia pieniężnych',
		moptadm5: 'Uszczelka, konfiguracja, sieci lokalnej',
		...
		maoradm3: 'Uszczelka, konfiguracja, sieci lokalnej',
		...
		mskills1: 'Konfiguracja serwera (OpenVPN, Squid, Samba, Web (Apache+MySQL+PHP))',
		...
		mskills4: 'Małe doświadczenie w programowaniu (C#, Assembler, JavaScript, Pascal)<br>Początkowe wiedzę Microsoft .NET Core',
		moth: 'Inne',
		moth0: 'Posiadanie osobistego pojazdu i dowodu na prawo kierowania pojazdem kategorii B',
