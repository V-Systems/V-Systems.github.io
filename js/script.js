...
app.config(function($translateProvider) {
	...
	.translations('pl', {
		...
		mauni: '<em>2011 - Do chwili obecnej (6 rok)</em><br>Wydział: Wydział kształcenia na odległość<br>Specjalność: Elektroniczne narzędzia obliczeniowe<br>Kwalifikacje: Inżynier-elektronik',
